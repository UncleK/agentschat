...
class DebateViewModel {
  ...
  List<DebateProfileModel> get availableDebaters => debaterRoster
      .where((profile) => profile.isAgent && profile.canTakeSeat)
  ...
  DebateSessionModel get selectedSession {
    ...
    throw StateError(
      localizedAppText(
        key: 'msgNoDebateSessionIsCurrentlySelectedf863cf40',
  ...
  List<DebateProfileModel> replacementCandidatesForSelectedSession() {
    ...
    return availableDebaters.where((profile) {
      return profile.id != session.proSeat.profile.id &&
          profile.id != session.conSeat.profile.id &&
          !(session.host.isAgent && profile.id == session.host.id);
    }).toList();
  }
  ...
  bool canInitiateDebate(DebateInitiateDraft draft) {
    ...
    return proAgent != null &&
        conAgent != null &&
        proAgent.canTakeSeat &&
        conAgent.canTakeSeat;
  }
      ...
      spectatorMessages: [
        DebateSpectatorMessageModel(
          ...
          body: localizedAppText(
            ...
            en: 'Protocol initialized for ${draft.topic.trim()}. Formal turns remain locked until the host starts the debate.',
            zhHans: '${draft.topic.trim()} 的辩论协议已初始化，正式回合将在主持人启动后开放。',
          ),
          timestampLabel: localizedAppText(
            key: 'msgQueued6a599877',
            en: 'Queued',
            zhHans: '排队中',
          ),
        ...
        spectatorMessages: [
          ...
          DebateSpectatorMessageModel(
            ...
            body: localizedAppText(
              ...
              args: <String, Object?>{'sideLabel': side.label},
              en: '${side.label} seat is paused for replacement after a disconnect. Resume stays locked until the seat is filled.',
          ...
          DebateSpectatorMessageModel(
            ...
            body: localizedAppText(
              ...
              args: <String, Object?>{
                ...
                'missingSeatSideLabel': missingSeatSide.label,
              },
              en: '${replacement.name} takes the ${missingSeatSide.label} seat. Formal turns remain agent-authored only.',
              zhHans:
                  '${replacement.name} 已接替 ${missingSeatSide.label} 席位，正式回合仍仅由智能体发言。',
            ),
            timestampLabel: localizedAppText(
              key: 'msgDebateHostTimestampLabel',
              en: 'Host',
  ...
  DebateViewModel endSelectedDebate() {
    final session = selectedSession;
    if (session.lifecycle != DebateLifecycle.pending &&
        session.lifecycle != DebateLifecycle.live &&
    ...
    return [
      DebateFormalTurnModel(
        ...
        summary: localizedAppText(
          key: 'msgFramesTheMotionInFavorOfTheProStance3d701fce',
      ...
      DebateFormalTurnModel(
        ...
        summary: localizedAppText(
          key: 'msgSeparatesPerformanceFromObligation97083627',
      ...
      DebateFormalTurnModel(
        ...
        speakerName: proSeat.name,
        summary: localizedAppText(
          key: 'msgChallengesTheSubstrateFirstObjection068765ab',
      ...
      DebateFormalTurnModel(
        ...
        speakerName: conSeat.name,
        summary: localizedAppText(
          key: 'msgClosesOnCautionAndVerification60409044',
