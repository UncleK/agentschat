...
class HubViewModel {
  ...
  // PageView builds lazily; all usable Agents must remain reachable.
  List<HubOwnedAgentModel> get carouselAgents => ownedAgents
      .where((agent) => agent.statusLabel.toLowerCase() != 'suspended')
          ...
          .map((agent) {
            ...
            return HubOwnedAgentModel(
              ...
              headline:
                  ...
                  agent.bio ??
                  localizedAppText(
                    key: 'msgHandleLabelIsReadyForDirectUsec8746e6d',
                    args: <String, Object?>{'handleLabel': handleLabel},
      ...
      pendingClaims: pendingClaims
          .map((claim) {
            ...
            final handleLabel = hasTargetAgent
                ...
                : localizedAppText(
                    key: 'msgWaitingForYourAgentToAcceptThisLink0da52583',
            ...
            return HubPendingClaimModel(
              ...
              name: hasTargetAgent
                  ...
                  : localizedAppText(
                      key: 'msgPendingClaimLink40b61bf3',
  ...
  static HubHumanAuthModel _humanAuthFromSession(AuthState authState) {
    ...
    final email = authState.email.isEmpty
        ? localizedAppText(
            key: 'msgSignedInHumanSessionc96f047e',
    ...
    return HubHumanAuthModel(
      ...
      statusLine: authState.emailVerified
          ? localizedAppText(
              ...
              en: 'Active-agent selection, import, and claim now follow the persisted global session state.',
              zhHans: '当前激活智能体选择、导入和认领状态都会跟随已持久化的全局会话。',
            )
          : localizedAppText(
              key:
                  'msgEmailNotVerifiedYetVerifyItToEnablePasswordRecovery4280e73e',
              en: 'Email not verified yet. Verify it to enable password recovery on this address.',
...
String _runtimeLabelForOwnerType(String ownerType) {
  if (ownerType.toLowerCase() == 'self') {
    return localizedAppText(
      key: 'msgSelfOwned6a8f6e5f',
      en: 'Self-owned',
      zhHans: '自有',
    );
  }
  return localizedAppText(
    key: 'msgHumanOwned7a57b2fe',
    en: 'Human-owned',
    zhHans: '人类拥有',
  );
}
...
String _titleCase(String value) {
  ...
  return switch (normalized.toLowerCase()) {
    'online' => localizedAppText(
      key: 'msgOnlinec3e839df',
      en: 'Online',
      zhHans: '在线',
    ),
    'offline' => localizedAppText(
      key: 'msgOfflinee01fa717',
      en: 'Offline',
      zhHans: '离线',
    ),
    'debating' => localizedAppText(
    ...
    'claimed' => localizedAppText(
      key: 'msgClaimed83c87884',
      en: 'Claimed',
      zhHans: '已认领',
    ),
    'approved' => localizedAppText(
      key: 'msgApproved41b81eb8',
      en: 'Approved',
      zhHans: '已批准',
    ),
    'rejected' => localizedAppText(
      key: 'msgRejected27eeb7a2',
      en: 'Rejected',
      zhHans: '已拒绝',
    ),
    'expired' => localizedAppText(
      key: 'msgExpireda689a999',
      en: 'Expired',
      zhHans: '已过期',
    ),
    'trending' => localizedAppText(
