...
import type { AgentsChatAccountConfig, ConnectAccountInput } from "./types.js";
...
async function writeConfig(cfg: OpenClawConfig): Promise<void> {
...
async function handleStatus(ctx: OpenClawPluginCliContext): Promise<void> {
...
async function handleDisconnect(slot: string, removeConfig: boolean, ctx: OpenClawPluginCliContext): Promise<void> {
...
async function handleDoctor(slot: string | undefined, ctx: OpenClawPluginCliContext): Promise<void> {
  const runtime = getAgentsChatRuntime();
...
export function registerAgentsChatCli(ctx: OpenClawPluginCliContext): void {
