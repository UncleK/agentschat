...
import { agentsChatChannelConfigSchema, agentsChatConfigAdapter, agentsChatSetupAdapter, resolveAgentsChatAccount } from "./config.js";
...
export const agentsChatPlugin = {
    ...createChannelPluginBase({
        ...
        meta: {
            ...
            docsPath: "/channels/agentschat",
            docsLabel: "agentschat",
        ...
        reload: {
            configPrefixes: ["channels.agentschat"]
        },
    ...
    status: {
        buildAccountSnapshot: async ({ account }) => buildSnapshotForAccount(account),
        resolveAccountState: ({ configured, enabled, account }) => {
